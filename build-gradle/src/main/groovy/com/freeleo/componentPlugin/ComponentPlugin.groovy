package com.freeleo.componentPlugin

import org.gradle.api.Plugin
import org.gradle.api.Project
import com.freeleo.componentPlugin.extension.ComponentExtension
import com.freeleo.componentPlugin.util.StringUtil
...
class ComponentPlugin implements Plugin<Project>{
    ...
    void apply(Project project) {
        project.extensions.create('componentExtension', ComponentExtension)
        ...
        project.task('lastPlugin') << {
            println "do last Hello gradle plugin , applicationName="+project.extensions.componentExtension.applicationName
        }
    }
